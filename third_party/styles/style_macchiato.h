#ifndef STYLE_MACCHIATO_H
#define STYLE_MACCHIATO_H

#define MACCHIATO_STYLE_PROPS_COUNT  17

static const GuiStyleProp macchiatoStyleProps[MACCHIATO_STYLE_PROPS_COUNT] = {
    { 0, 0, (int)0x6e738dff },    // DEFAULT_BORDER_COLOR_NORMAL   (Overlay 0)
    { 0, 1, (int)0x363a4fff },    // DEFAULT_BASE_COLOR_NORMAL     (Surface 0)
    { 0, 2, (int)0xcad3f5ff },    // DEFAULT_TEXT_COLOR_NORMAL     (Text)
    { 0, 3, (int)0xb7bdf8ff },    // DEFAULT_BORDER_COLOR_FOCUSED  (Lavender)
    { 0, 4, (int)0x494d64ff },    // DEFAULT_BASE_COLOR_FOCUSED    (Surface 1)
    { 0, 5, (int)0xcad3f5ff },    // DEFAULT_TEXT_COLOR_FOCUSED    (Text)
    { 0, 6, (int)0x8aadf4ff },    // DEFAULT_BORDER_COLOR_PRESSED  (Blue)
    { 0, 7, (int)0x5b6078ff },    // DEFAULT_BASE_COLOR_PRESSED    (Surface 2)
    { 0, 8, (int)0xcad3f5ff },    // DEFAULT_TEXT_COLOR_PRESSED    (Text)
    { 0, 9, (int)0x494d64ff },    // DEFAULT_BORDER_COLOR_DISABLED (Surface 1)
    { 0, 10, (int)0x1e2030ff },   // DEFAULT_BASE_COLOR_DISABLED   (Mantle)
    { 0, 11, (int)0x6e738dff },   // DEFAULT_TEXT_COLOR_DISABLED   (Overlay 0)
    { 0, 16, (int)0x00000010 },   // DEFAULT_TEXT_SIZE 
    { 0, 17, (int)0x00000000 },   // DEFAULT_TEXT_SPACING 
    { 0, 18, (int)0x6e738dff },   // DEFAULT_LINE_COLOR            (Overlay 0)
    { 0, 19, (int)0x24273aff },   // DEFAULT_BACKGROUND_COLOR      (Base)
    { 0, 20, (int)0x00000008 },   // DEFAULT_TEXT_LINE_SPACING 
};

#define MACCHIATO_STYLE_FONT_ATLAS_COMP_SIZE 1860
static unsigned char macchiatoFontData[MACCHIATO_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xed,
...
static const Rectangle macchiatoFontRecs[189] = {
    ...
    { 173, 4, 6 , 12 }, { 187, 4, 5 , 11 }, { 200, 4, 2 , 11 }, { 210, 4, 5 , 11 }, { 223, 4, 5 , 11 },
    { 236, 4, 5 , 11 }, { 249, 4, 5 , 11 }, { 262, 4, 5 , 11 }, { 275, 4, 5 , 11 }, { 288, 4, 5 , 11 },
    { 301, 4, 5 , 11 }, { 314, 4, 1 , 8 }, { 323, 4, 1 , 10 }, { 332, 4, 4 , 5 }, { 344, 4, 5 , 3 },
    { 357, 4, 4 , 5 }, { 369, 4, 5 , 11 }, { 382, 4, 11 , 11 }, { 401, 4, 5 , 11 }, { 414, 4, 5 , 11 },
    { 427, 4, 5 , 11 }, { 440, 4, 5 , 11 }, { 453, 4, 5 , 11 }, { 466, 4, 5 , 11 }, { 479, 4, 5 , 11 },
    { 492, 4, 5 , 11 }, { 4, 28, 1 , 11 }, { 13, 28, 5 , 11 }, { 26, 28, 5 , 11 }, { 39, 28, 5 , 11 },
    { 52, 28, 7 , 11 }, { 67, 28, 5 , 11 }, { 80, 28, 5 , 11 }, { 93, 28, 5 , 11 }, { 106, 28, 5 , 13 },
    { 119, 28, 5 , 11 }, { 132, 28, 5 , 11 }, { 145, 28, 5 , 11 }, { 158, 28, 5 , 11 }, { 171, 28, 5 , 11 },
    { 184, 28, 7 , 11 }, { 199, 28, 5 , 11 }, { 212, 28, 5 , 11 }, { 225, 28, 5 , 11 }, { 238, 28, 2 , 13 },
    { 248, 28, 6 , 12 }, { 262, 28, 2 , 13 }, { 272, 28, 5 , 4 }, { 285, 28, 5 , 1 }, { 298, 28, 2 , 2 },
    { 308, 28, 5 , 8 }, { 321, 28, 5 , 11 }, { 334, 28, 5 , 8 }, { 347, 28, 5 , 11 }, { 360, 28, 5 , 8 },
    { 373, 28, 4 , 11 }, { 385, 28, 5 , 10 }, { 398, 28, 5 , 11 }, { 411, 28, 1 , 11 }, { 420, 28, 1 , 13 },
    { 429, 28, 5 , 11 }, { 442, 28, 1 , 11 }, { 451, 28, 7 , 8 }, { 466, 28, 5 , 8 }, { 479, 28, 5 , 8 },
    { 492, 28, 5 , 10 }, { 4, 52, 5 , 10 }, { 17, 52, 4 , 8 }, { 29, 52, 5 , 8 }, { 42, 52, 3 , 11 },
    { 53, 52, 5 , 8 }, { 66, 52, 5 , 8 }, { 79, 52, 7 , 8 }, { 94, 52, 5 , 8 }, { 107, 52, 5 , 10 },
    { 120, 52, 5 , 8 }, { 133, 52, 3 , 13 }, { 144, 52, 1 , 15 }, { 153, 52, 3 , 13 }, { 164, 52, 5 , 3 },
    { 177, 52, 1 , 11 }, { 186, 52, 5 , 11 }, { 199, 52, 5 , 10 }, { 212, 52, 5 , 10 }, { 225, 52, 5 , 10 },
    { 238, 52, 0 , 0 }, { 246, 52, 0 , 0 }, { 254, 52, 0 , 0 }, { 262, 52, 7 , 8 }, { 277, 52, 0 , 0 },
    { 285, 52, 0 , 0 }, { 293, 52, 5 , 3 }, { 306, 52, 7 , 8 }, { 321, 52, 5 , 1 }, { 334, 52, 3 , 3 },
    { 345, 52, 5 , 7 }, { 358, 52, 0 , 0 }, { 366, 52, 0 , 0 }, { 374, 52, 0 , 0 }, { 382, 52, 5 , 10 },
    { 395, 52, 7 , 11 }, { 410, 52, 1 , 1 }, { 419, 52, 0 , 0 }, { 427, 52, 0 , 0 }, { 435, 52, 0 , 0 },
    { 443, 52, 0 , 0 }, { 451, 52, 0 , 0 }, { 459, 52, 0 , 0 }, { 467, 52, 5 , 13 }, { 480, 52, 5 , 11 },
    { 493, 52, 5 , 14 }, { 4, 76, 5 , 14 }, { 17, 76, 5 , 14 }, { 30, 76, 5 , 14 }, { 43, 76, 5 , 14 },
    { 56, 76, 5 , 14 }, { 69, 76, 9 , 11 }, { 86, 76, 5 , 13 }, { 99, 76, 5 , 14 }, { 112, 76, 5 , 14 },
    { 125, 76, 5 , 14 }, { 138, 76, 5 , 13 }, { 151, 76, 2 , 14 }, { 161, 76, 2 , 14 }, { 171, 76, 3 , 14 },
    { 197, 1, 1, 7, { 0 }}, { 198, 1, 3, 11, { 0 }}, { 199, 1, 3, 7, { 0 }}, { 200, 1, 0, 7, { 0 }}, { 201, 1, 0, 7, { 0 }},
    { 202, 1, 0, 7, { 0 }}, { 203, 1, 1, 7, { 0 }}, { 204, 0, 0, 3, { 0 }}, { 205, 1, 0, 3, { 0 }}, { 206, 0, 0, 3, { 0 }},
    { 207, 0, 1, 3, { 0 }}, { 208, 1, 3, 7, { 0 }}, { 209, 1, 0, 7, { 0 }}, { 210, 1, 0, 7, { 0 }}, { 211, 1, 0, 7, { 0 }},
    { 212, 1, 0, 7, { 0 }}, { 213, 1, 0, 7, { 0 }}, { 214, 1, 1, 7, { 0 }}, { 215, 1, 7, 7, { 0 }}, { 216, 1, 2, 7, { 0 }},
    { 217, 1, 0, 7, { 0 }}, { 218, 1, 0, 7, { 0 }}, { 219, 1, 0, 7, { 0 }}, { 220, 1, 1, 7, { 0 }}, { 221, 1, 0, 7, { 0 }},
    { 222, 1, 3, 7, { 0 }}, { 223, 1, 3, 7, { 0 }}, { 224, 1, 3, 7, { 0 }}, { 225, 1, 3, 7, { 0 }}, { 226, 1, 3, 7, { 0 }},
    { 227, 1, 3, 7, { 0 }}, { 228, 1, 4, 7, { 0 }}, { 229, 1, 4, 7, { 0 }}, { 230, 1, 6, 11, { 0 }}, { 231, 1, 6, 7, { 0 }},
    { 232, 1, 3, 7, { 0 }}, { 233, 1, 3, 7, { 0 }}, { 234, 1, 3, 7, { 0 }}, { 235, 1, 4, 7, { 0 }}, { 236, 0, 3, 3, { 0 }},
    { 237, 1, 3, 3, { 0 }}, { 238, 0, 3, 3, { 0 }}, { 239, 0, 4, 3, { 0 }}, { 240, 1, 3, 7, { 0 }}, { 241, 1, 3, 7, { 0 }},
    { 242, 1, 3, 7, { 0 }}, { 243, 1, 3, 7, { 0 }}, { 244, 1, 3, 7, { 0 }}, { 245, 1, 3, 7, { 0 }}, { 246, 1, 4, 7, { 0 }},
    { 247, 1, 7, 7, { 0 }}, { 248, 1, 5, 7, { 0 }}, { 249, 1, 3, 7, { 0 }}, { 250, 1, 3, 7, { 0 }}, { 251, 1, 3, 7, { 0 }},
    { 252, 1, 4, 7, { 0 }}, { 253, 1, 3, 7, { 0 }}, { 254, 1, 6, 6, { 0 }}, { 255, 1, 4, 7, { 0 }},
};

static void GuiLoadStyleMacchiato(void)
{
    for (int i = 0; i < MACCHIATO_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(macchiatoStyleProps[i].controlId, macchiatoStyleProps[i].propertyId, macchiatoStyleProps[i].propertyValue);
    }
    int macchiatoFontDataSize = 0;
    unsigned char *data = DecompressData(macchiatoFontData, MACCHIATO_STYLE_FONT_ATLAS_COMP_SIZE, &macchiatoFontDataSize);
    ...
    memcpy(font.recs, macchiatoFontRecs, font.glyphCount*sizeof(Rectangle));
    font.glyphs = (GlyphInfo *)RAYGUI_MALLOC(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, macchiatoFontGlyphs, font.glyphCount*sizeof(GlyphInfo));
    GuiSetFont(font);
