#ifndef STYLE_LATTE_H
#define STYLE_LATTE_H

#define LATTE_STYLE_PROPS_COUNT  17

static const GuiStyleProp latteStyleProps[LATTE_STYLE_PROPS_COUNT] = {
    { 0, 0, (int)0x9ca0b0ff },    // DEFAULT_BORDER_COLOR_NORMAL   (Overlay 0)
    { 0, 1, (int)0xccd0daff },    // DEFAULT_BASE_COLOR_NORMAL     (Surface 0)
    { 0, 2, (int)0x4c4f69ff },    // DEFAULT_TEXT_COLOR_NORMAL     (Text)
    { 0, 3, (int)0x7287fdff },    // DEFAULT_BORDER_COLOR_FOCUSED  (Lavender)
    { 0, 4, (int)0xbcc0ccff },    // DEFAULT_BASE_COLOR_FOCUSED    (Surface 1)
    { 0, 5, (int)0x4c4f69ff },    // DEFAULT_TEXT_COLOR_FOCUSED    (Text)
    { 0, 6, (int)0x1e66f5ff },    // DEFAULT_BORDER_COLOR_PRESSED  (Blue)
    { 0, 7, (int)0xacb0beff },    // DEFAULT_BASE_COLOR_PRESSED    (Surface 2)
    { 0, 8, (int)0x4c4f69ff },    // DEFAULT_TEXT_COLOR_PRESSED    (Text)
    { 0, 9, (int)0xbcc0ccff },    // DEFAULT_BORDER_COLOR_DISABLED (Surface 1)
    { 0, 10, (int)0xe6e9efff },   // DEFAULT_BASE_COLOR_DISABLED   (Mantle)
    { 0, 11, (int)0x9ca0b0ff },   // DEFAULT_TEXT_COLOR_DISABLED   (Overlay 0)
    { 0, 16, (int)0x00000010 },   // DEFAULT_TEXT_SIZE 
    { 0, 17, (int)0x00000000 },   // DEFAULT_TEXT_SPACING 
    { 0, 18, (int)0x9ca0b0ff },   // DEFAULT_LINE_COLOR            (Overlay 0)
    { 0, 19, (int)0xeff1f5ff },   // DEFAULT_BACKGROUND_COLOR      (Base)
    { 0, 20, (int)0x00000008 },   // DEFAULT_TEXT_LINE_SPACING 
};

#define LATTE_STYLE_FONT_ATLAS_COMP_SIZE 1860
static unsigned char latteFontData[LATTE_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xed,
...
static const Rectangle latteFontRecs[189] = {
...
static const GlyphInfo latteFontGlyphs[189] = {
...
static void GuiLoadStyleLatte(void)
{
    for (int i = 0; i < LATTE_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(latteStyleProps[i].controlId, latteStyleProps[i].propertyId, latteStyleProps[i].propertyValue);
    }
    int latteFontDataSize = 0;
    unsigned char *data = DecompressData(latteFontData, LATTE_STYLE_FONT_ATLAS_COMP_SIZE, &latteFontDataSize);
    ...
    memcpy(font.recs, latteFontRecs, font.glyphCount*sizeof(Rectangle));
    font.glyphs = (GlyphInfo *)RAYGUI_MALLOC(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, latteFontGlyphs, font.glyphCount*sizeof(GlyphInfo));
    GuiSetFont(font);
